...
class Gps_Plotter {
	...
	public function enqueue_scripts() { 
        ...
        wp_enqueue_script( $this->plugin_slug . '-gpsplotter-google-maps', '//maps.googleapis.com/maps/api/js?libraries=places&key='.get_option("gps-plotter-api-key"), array(), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-gpsplotter-map-js', plugins_url( 'assets/js/gpsplotter-map.js', __FILE__ ), array('jquery'), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-gpsplotter-leaflet-js', plugins_url( 'assets/js/leaflet-0.7.5/leaflet.js', __FILE__ ), array('jquery'), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-gpsplotter-google-js', plugins_url( 'assets/js/leaflet-plugins/google.js', __FILE__ ), array('jquery'), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-gpsplotter-bing-js', plugins_url( 'assets/js/leaflet-plugins/bing.js', __FILE__ ), array('jquery'), self::VERSION );        
